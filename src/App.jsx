    ...
    <>
      <main>
        <div className="images">
          <img id='tom' src="/back/background-2.png" alt="" />
          <img id='nav' src="/back/background-3.png" alt="" />
          <img id='msi' src="/back/background-4.png" alt="" />
          <img id='phone' src="/back/background-5.png" alt="" />
          <img id='fest' src="/back/background-6.png" alt="" />
          <img id='ken' src="/back/background-7.png" alt="" />
          <img id='opera' src="/back/background-8.png" alt="" />
        </div>
      ...
      <section  id="section-1">
        ...
        <path d="M30.4351,61.1758h-10.4155L0,116.838H10.3479L30.4351,61.1758Z"></path>
          ...
          <div className="nav-elem"> <span>--    Our ShowReel</span></div>
          <div className="nav-elem"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 4H21V6H3V4ZM3 11H15V13H3V11ZM3 18H21V20H3V18Z"></path></svg></div>
        </nav>
        <div id="content">
        <div id='left' ><h1>We <br />Make <br />Good <br />Shit</h1></div>
        <div id='right'></div>
        </div>
      </section>
      <section id="section-2">
      <div id='left' ></div>
      <div id='right'><h1>Dogstudio is a multidisciplinary <br />creative studio at the intersection <br />of art, design and technology.</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores quo pariatur, quos neque laborum provident placeat magni possimus dolores fugit obcaecati unde, mollitia similique reprehenderit sed? Consequuntur dolore minima esse.</p></div></section>
      <section id="section-3">
        <div className="main">
          <div img-title="tom" className="class"><div className="right">2020 - ONGOING</div><div className="left">Tomorrowland</div></div>
          <div img-title="nav" className="class"><div className="right">2018 - Today</div><div className="left">Navy Pier</div></div>
          <div img-title="msi" className="class"><div className="right">2015 - Today</div><div className="left">MSI Chicago</div></div>
          <div img-title="phone" className="class"><div className="right">2016</div><div className="left">This Was Louise's Phone</div></div>
          <div img-title="fest" className="class"><div className="right">2012 - Today</div><div className="left">KKIK Festival</div></div>
          <div img-title="ken" className="class"><div className="right">2017</div><div className="left">The Kennedy Center</div></div>
          <div img-title="opera" className="class"><div className="right">2016 - Ongoing</div><div className="left">Royal Opera Of Wallonia</div></div>
        </div>
      </section>
      <section id="section-4">
        <div className="top">
          <div className="left"><h1>
            We're crafting <br />emotional <br />experience aimed <br />at improving <br />results</h1></div>
      ...
      <div className="bottom">
        ...
        <div className="right"><p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis qui odio eos commodi blanditiis nisi quia voluptates reprehenderit distinctio cum accusantium explicabo repellat asperiores dolorum quas autem magnam, architecto quisquam!</p></div>
        </div>
      </section>
      </main>
    </>
